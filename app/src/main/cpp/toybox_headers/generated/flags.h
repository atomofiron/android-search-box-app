...
// cpio   (ignore-devno)(renumber-inodes)(quiet)(no-preserve-owner)md(make-directories)uH:p|i|t|F:v(verbose)o|[!pio][!pot][!pF]
#undef OPTSTR_cpio
...
// cut   b*|c*|f*|F*|C*|O(output-delimiter):d:sDn[!cbfF]
#undef OPTSTR_cut
...
// date   d:D:I(iso-8601):;r:s:u(utc)[!dr]
#undef OPTSTR_date
...
// gzip   n(no-name)cdfk123456789[-123456789]
#undef OPTSTR_gzip
...
// install   <1cdDp(preserve-timestamps)svt:m:o:g:
...
// ls (color):;(full-time)(show-control-chars)ZgoACFHLNRSabcdfhikl@mnpqrstuw#=80<0x1[-Cxm1][-Cxml][-Cxmo][-Cxmg][-cu][-ftS][-HL][-Nqb] (color):;(full-time)(show-control-chars)ZgoACFHLNRSabcdfhikl@mnpqrstuw#=80<0x1[-Cxm1][-Cxml][-Cxmo][-Cxmg][-cu][-ftS][-HL][-Nqb]
#undef OPTSTR_ls
#define OPTSTR_ls "(color):;(full-time)(show-control-chars)ZgoACFHLNRSabcdfhikl@mnpqrstuw#=80<0x1[-Cxm1][-Cxml][-Cxmo][-Cxmg][-cu][-ftS][-HL][-Nqb]"
#ifdef CLEANUP_ls
#undef CLEANUP_ls
#undef FOR_ls
#undef FLAG_1
...
// patch   >2(no-backup-if-mismatch)(dry-run)xF#g#fulp#d:i:Rs(quiet)
#undef OPTSTR_patch
#define OPTSTR_patch ">2(no-backup-if-mismatch)(dry-run)xF#g#fulp#d:i:Rs(quiet)"
#ifdef CLEANUP_patch
#undef CLEANUP_patch
#undef FOR_patch
#undef FLAG_s
...
// readlink   <1vnf(canonicalize)emqz[-mef][-qv]
...
// sort   gS:T:mo:k*t:xVbMCcszdfirun
#undef OPTSTR_sort
...
// tar   &(show-transformed-names)(selinux)(restrict)(full-time)(no-recursion)(null)(numeric-owner)(no-same-permissions)(overwrite)(exclude)*(mode):(mtime):(group):(owner):(to-command):~(strip-components)(strip)#~(transform)(xform)*o(no-same-owner)p(same-permissions)k(keep-old)c(create)|h(dereference)x(extract)|t(list)|v(verbose)J(xz)j(bzip2)z(gzip)S(sparse)O(to-stdout)P(absolute-names)m(touch)X(exclude-from)*T(files-from)*I(use-compress-program):C(directory):f(file):a[!txc][!jzJa]
#undef OPTSTR_tar
#define OPTSTR_tar "&(show-transformed-names)(selinux)(restrict)(full-time)(no-recursion)(null)(numeric-owner)(no-same-permissions)(overwrite)(exclude)*(mode):(mtime):(group):(owner):(to-command):~(strip-components)(strip)#~(transform)(xform)*o(no-same-owner)p(same-permissions)k(keep-old)c(create)|h(dereference)x(extract)|t(list)|v(verbose)J(xz)j(bzip2)z(gzip)S(sparse)O(to-stdout)P(absolute-names)m(touch)X(exclude-from)*T(files-from)*I(use-compress-program):C(directory):f(file):a[!txc][!jzJa]"
#ifdef CLEANUP_tar
#undef CLEANUP_tar
#undef FOR_tar
#undef FLAG_a
...
// timeout   <2^(foreground)(preserve-status)vk:s(signal):i
...
#define FLAG_no_preserve_owner (FORCED_FLAG<<10)
#define FLAG_quiet (FORCED_FLAG<<11)
#define FLAG_renumber_inodes (FORCED_FLAG<<12)
#define FLAG_ignore_devno (FORCED_FLAG<<13)
#endif
...
#define FLAG_i (FORCED_FLAG<<10)
#define FLAG_w (FORCED_FLAG<<11)
#define FLAG_t (FORCED_FLAG<<12)
#define FLAG_u (FORCED_FLAG<<13)
#define FLAG_b (FORCED_FLAG<<14)
#define FLAG_d (FORCED_FLAG<<15)
#define FLAG_B (FORCED_FLAG<<16)
#define FLAG_strip_trailing_cr (FORCED_FLAG<<17)
#define FLAG_color (FORCED_FLAG<<18)
#define FLAG_new_line_format (FORCED_FLAG<<19)
#define FLAG_old_line_format (FORCED_FLAG<<20)
#define FLAG_unchanged_line_format (FORCED_FLAG<<21)
#endif
...
#define FLAG_S (1LL<<20)
#define FLAG_R (1LL<<21)
#define FLAG_N (1LL<<22)
#define FLAG_L (1LL<<23)
#define FLAG_H (1LL<<24)
#define FLAG_F (1LL<<25)
#define FLAG_C (1LL<<26)
#define FLAG_A (1LL<<27)
#define FLAG_o (1LL<<28)
#define FLAG_g (1LL<<29)
#define FLAG_Z (1LL<<30)
#define FLAG_show_control_chars (1LL<<31)
#define FLAG_full_time (1LL<<32)
#define FLAG_color (1LL<<33)
#endif
...
#define FLAG_u (FORCED_FLAG<<6)
#define FLAG_f (FORCED_FLAG<<7)
#define FLAG_g (FORCED_FLAG<<8)
#define FLAG_F (FORCED_FLAG<<9)
#define FLAG_x (FORCED_FLAG<<10)
#define FLAG_dry_run (FORCED_FLAG<<11)
#define FLAG_no_backup_if_mismatch (FORCED_FLAG<<12)
#endif
...
#define FLAG_V (FORCED_FLAG<<12)
#define FLAG_x (FORCED_FLAG<<13)
#define FLAG_t (FORCED_FLAG<<14)
#define FLAG_k (FORCED_FLAG<<15)
#define FLAG_o (FORCED_FLAG<<16)
#define FLAG_m (FORCED_FLAG<<17)
#define FLAG_T (FORCED_FLAG<<18)
...
#define FLAG_O (FORCED_FLAG<<8)
#define FLAG_S (FORCED_FLAG<<9)
#define FLAG_z (FORCED_FLAG<<10)
#define FLAG_j (FORCED_FLAG<<11)
#define FLAG_J (FORCED_FLAG<<12)
#define FLAG_v (FORCED_FLAG<<13)
#define FLAG_t (FORCED_FLAG<<14)
#define FLAG_x (FORCED_FLAG<<15)
#define FLAG_h (FORCED_FLAG<<16)
#define FLAG_c (FORCED_FLAG<<17)
#define FLAG_k (FORCED_FLAG<<18)
#define FLAG_p (FORCED_FLAG<<19)
#define FLAG_o (FORCED_FLAG<<20)
#define FLAG_xform (FORCED_FLAG<<21)
#define FLAG_strip (FORCED_FLAG<<22)
#define FLAG_to_command (FORCED_FLAG<<23)
#define FLAG_owner (FORCED_FLAG<<24)
#define FLAG_group (FORCED_FLAG<<25)
#define FLAG_mtime (FORCED_FLAG<<26)
#define FLAG_mode (FORCED_FLAG<<27)
#define FLAG_exclude (FORCED_FLAG<<28)
#define FLAG_overwrite (FORCED_FLAG<<29)
#define FLAG_no_same_permissions (FORCED_FLAG<<30)
#define FLAG_numeric_owner (FORCED_FLAG<<31)
#define FLAG_null (FORCED_FLAG<<32)
#define FLAG_no_recursion (FORCED_FLAG<<33)
#define FLAG_full_time (FORCED_FLAG<<34)
#define FLAG_restrict (FORCED_FLAG<<35)
#define FLAG_selinux (FORCED_FLAG<<36)
#define FLAG_show_transformed_names (FORCED_FLAG<<37)
#endif
...
#define FLAG_k (FORCED_FLAG<<2)
#define FLAG_v (FORCED_FLAG<<3)
#define FLAG_preserve_status (FORCED_FLAG<<4)
#define FLAG_foreground (FORCED_FLAG<<5)
#endif
