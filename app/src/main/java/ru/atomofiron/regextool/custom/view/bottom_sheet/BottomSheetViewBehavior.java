 ...
 */
public class BottomSheetViewBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private boolean shapeThemingEnabled = true;
    ...
    public BottomSheetViewBehavior() {}

    public BottomSheetViewBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BottomSheetViewBehavior);
        boolean hasBackgroundTint = a.hasValue(R.styleable.BottomSheetViewBehavior_view_backgroundTint);
        ColorStateList bottomSheetColor = null;
        if (hasBackgroundTint) {
            bottomSheetColor = MaterialResources.getColorStateList(
                    context, a, R.styleable.BottomSheetViewBehavior_view_backgroundTint);
        }
        createMaterialShapeDrawable(context, attrs, hasBackgroundTint, bottomSheetColor);
        createShapeValueAnimator();

        if (VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP) {
            this.elevation = a.getDimension(R.styleable.BottomSheetViewBehavior_android_elevation, -1);
        }

        TypedValue value = a.peekValue(R.styleable.BottomSheetViewBehavior_view_behavior_peekHeight);
        if (value != null && value.data == PEEK_HEIGHT_AUTO) {
            setPeekHeight(value.data);
        } else {
            setPeekHeight(a.getDimensionPixelSize(R.styleable.BottomSheetViewBehavior_view_behavior_peekHeight, PEEK_HEIGHT_AUTO));
        }
        setHideable(a.getBoolean(R.styleable.BottomSheetViewBehavior_view_behavior_hideable, hideable));
        setFitToContents(a.getBoolean(R.styleable.BottomSheetViewBehavior_view_behavior_fitToContents, fitToContents));
        setSkipCollapsed(a.getBoolean(R.styleable.BottomSheetViewBehavior_view_behavior_skipCollapsed, skipCollapsed));
        setHalfExpandedRatio(a.getFloat(R.styleable.BottomSheetViewBehavior_view_behavior_halfExpandedRatio, halfExpandedRatio));
        setExpandedOffset(a.getInt(R.styleable.BottomSheetViewBehavior_view_behavior_expandedOffset, 0));
        a.recycle();
     ...
     * @attr ref R.styleable#BottomSheetViewBehavior_Layout_behavior_peekHeight
     */
     ...
     * @attr R.styleable#BottomSheetViewBehavior_Layout_behavior_halfExpandedRatio
     */
    public void setHalfExpandedRatio(@FloatRange(from = 0.0f, to = 1.0f) float ratio) {
        Log.e("atomofiron", "setHalfExpandedRatio " + ratio);

        if ((ratio <= 0) || (ratio > 1)) {
            throw new IllegalArgumentException("ratio must be a float value in range (0, 1]");
        }
     ...
     * @attr R.styleable#BottomSheetViewBehavior_Layout_behavior_expandedOffset
     */
     ...
     * @attr ref R.styleable#BottomSheetViewBehavior_Layout_behavior_hideable
     */
     ...
     * @attr ref R.styleable#BottomSheetViewBehavior_Layout_behavior_skipCollapsed
     */
     ...
     * @attr ref
     *     R.styleable#BottomSheetViewBehavior_Layout_behavior_skipCollapsed
     */
    ...
    private void createMaterialShapeDrawable(
        ...
        if (this.shapeThemingEnabled) {
            ...
            ShapeAppearanceModel shapeAppearanceModelDefault = ShapeAppearanceModel
                    .builder(context, attrs, R.attr.bottomSheetStyle, R.style.Widget_Design_BottomSheet_Modal)
                    .build();
    ...
    private void startSettlingAnimation(View child, int state, int top, boolean settleFromViewDragHelper) {
